...
use Anastasia\Blog\Blogs\{Article, Person\Name, User, UUID};
...
class SqliteArticlesRepositoryTest extends TestCase
{
    public function testItThrowsAnExceptionWhenArticleNotFound(): void
    {
        ...
        $repository = new SqliteArticlesRepo($connectionMock);
        $this->expectException(ArticleNotFoundException::class);
        $this->expectExceptionMessage('Cannot find article: 94b55fcc-8102-441f-b24c-ae97e8c2d2f7');
    ...
    public function testItSavesArticleToDatabase(): void
    {
        ...
        $repository = new SqliteArticlesRepo($connectionStub);
