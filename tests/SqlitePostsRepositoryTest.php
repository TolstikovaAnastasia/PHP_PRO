...
use Anastasia\Blog\Exceptions\{InvalidArgumentException, PostNotFoundException, UserNotFoundException};
...
class SqlitePostsRepositoryTest extends TestCase
{
    ...
    public function testItGetPostByUuid(): void
    {
        ...
        $postRepository = new SqlitePostsRepo($connectionStub, new DummyLogger());
        $post = $postRepository->get(new UUID('94b55fcc-8102-441f-b24c-ae97e8c2d2f7'));

        $this->assertSame('94b55fcc-8102-441f-b24c-ae97e8c2d2f7', (string)$post->uuid());
    }
}