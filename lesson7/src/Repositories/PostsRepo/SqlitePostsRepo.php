...
class SqlitePostsRepo implements PostsRepositoryInterface
{
    ...
    public function get(UUID $uuid): Post
    {
        /*$statement = $this->connection->prepare(
            'SELECT posts.uuid as post_uuid, users.uuid as users_uuid, users.userName as userName, users.firstName as firstName, users.lastName as lastName, users.password as password
